export const Button = (props: React.PropsWithChildren) => {
  return (
    <button className="relative px-3 py-2 font-cinzel  text-sm font-medium  hover:from-[#000000] hover:to-[#7A1000]  rounded-full bg-gradient-to-b from-[#7A1000] to-[#FE9D00] shadow-[0px_0px_12px_#A92000] transition duration-1000">
