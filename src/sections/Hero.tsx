...
import ImageBlocksWrapper from "../components/ui/heroimg";
...
export const Hero = () => {
  ...
  return (
    <section className="flex flex-col-reverse md:flex-row w-full h-auto md:h-[80vh] overflow-hidden relative">
  {/* Left Section */}
  <div
    className="flex flex-col items-center justify-center w-full md:w-1/2 h-[70vh] md:h-auto relative"
    style={{
      maskImage: "linear-gradient(to right, transparent, black 50%, black 50%, transparent)",
      WebkitMaskImage: "linear-gradient(to right, transparent, black 50%, black 50%, transparent)", // for Safari
    }}
  >
  ...
  <div className="w-full mt-8 md:w-1/2 h-[40vh] md:h-full flex items-center justify-center">
    <ImageBlocksWrapper />
  </div>
</section>
...
const colors = ["#E25319", "#FE9D00", "#7A1000"];
const sampleArcs = [
  {
    order: 1,
    startLat: -19.885592,
