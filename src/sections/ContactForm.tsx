...
const MapSection: React.FC = () => (
  ...
  >
    <div className="bg-black/65 border border-yellow-500 shadow-md rounded-lg p-6 h-full">
        ...
        >
          <div>
            ...
            <input
              ...
              type="text"
              id="name"
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm bg-gray-900/50 text-green-500"
          ...
          <button
            ...
            className="w-full px-4 py-2 text-white bg-gradient-to-r from-yellow-500 to-violet-900 rounded-md hover:opacity-90 focus:ring-2 focus:ring-yellow-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
...
export const ContactSection: React.FC = () => {
  return (
    <section className="container mx-auto px-4 mt-8 py-10">
      <motion.div
        initial="hidden"
        animate="visible"
